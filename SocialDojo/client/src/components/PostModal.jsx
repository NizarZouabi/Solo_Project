...
const PostModal = () => {
    ...
    return (
        <div className='container position: absolute top-0 md:left-36 w-full md:w-auto mt-48'>
            <input className='container relative top-0 md:left-80 w-full md:w-auto px-5 py-1 mt-10 bg-white border rounded-xl border-gray-400 shadow-md outline-yellow-200 ms-80' style={{ position: 'sticky', width: '1300px' }} placeholder='Write a post' onClick={() => setVisible(true)}></input>
