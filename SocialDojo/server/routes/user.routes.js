...
module.exports = (app) => {
  ...
  app.post("/user/:userId/conversation/:friendId/messages", authenticate, UserController.saveMessage);
  app.get("/user/:userId/conversation/:friendId/messages/show", authenticate, UserController.showMessages);
};
